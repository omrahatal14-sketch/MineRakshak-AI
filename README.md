...
AI-based Smart Governance and Compliance Monitoring Platform for Coal Mines.

## Architecture

```
minerakshak-ai/
├── frontend/     Next.js 14 (App Router) + Tailwind (role-based dashboards)
├── backend/      Node.js + Express + Firebase Admin (REST API, RBAC, Firestore access)
├── ai-service/   Python + FastAPI + Scikit-learn    (risk scoring, hazard vision)
